  ...
  <div className='container'>
    <div className='heading-title'>
      ...
      <p style={{ fontSize: '24px' }}>
        At Gamut Studio, we build badass, high-performance digital solutions that turn clicks into conversions and ideas into revenue. Scalable tech, seamless UX, and straight-up results—because slow and clunky doesn’t cut it. Let’s make your business move fast and break limits.
      </p>
    </div>
